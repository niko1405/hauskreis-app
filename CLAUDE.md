...
1. **Host-Zuteilung**
   ...
   - **Die Fakten reden in Abenden, nicht in Prozent.** „0 statt 25 % der Abende" stellte zwei gerundete Anteile nebeneinander, und niemand konnte sagen, was davon gut ist — bei einem Zuhause ohne Historie stand dort sogar eine Aussage über gar nichts. Jetzt kommt zuerst das Urteil („seltener dran als üblich") und dahinter die Zahlen („3 von 14 Abenden, üblich wären 5"). Das Urteil stammt aus **derselben** Größe, nach der sortiert wird (`credit`); zwei Größen für dieselbe Aussage liefen irgendwann auseinander, und dann stünde „öfter als üblich" über dem obersten Vorschlag. Gedruckt wird die Zahl trotzdem nie — sie ist gedeckelt und misst die Länge eines Rückstands gar nicht
