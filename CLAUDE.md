...
1. **Host-Zuteilung**
   ...
   - **Der Gastgeber-Vorschlag sah bis dahin nur Gastgeber-Dienste.** Damit war „wer hat am wenigsten zu tun, über alle Rollen" beim Gastgeber außer Kraft — wer an dem Abend ohnehin das Thema vorbereitet, stand trotzdem oben —, und `HOUSEHOLD_BUSY` konnte gar nicht auftreten: Es sucht in der Ereignisliste nach fremden Rollen am selben Abend, und dort standen keine
