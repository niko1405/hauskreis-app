...
1. **Host-Zuteilung**
   ...
   - **„Zuletzt dran" zählt vom Abend aus, nicht von heute.** Die Zeile lief durch die Countdown-Formatierung, und die misst gegen den heutigen Tag: Wer in vier Tagen die Musik macht, stand beim Einteilen für einen Abend in vier Wochen als „zuletzt in vier Tagen" da — ein Dienst, der aus Sicht dieses Abends dreieinhalb Wochen zurückliegt. Die Rangfolge selbst rechnete immer schon richtig (`daysSinceLastAssignment` gegen das Zieldatum), die Zahl stand nur ungenutzt daneben. Jetzt steht dort der Abstand ohne Bezugspunkt: „zuletzt 3 Wochen vor diesem Abend"
