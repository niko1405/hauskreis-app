 ...
 *
 * Verkleinert wird auf dem Server (`sharp`, 1280×640, WebP). Hier geht die
 * Datei so raus, wie sie gewählt wurde; was ankommt, muss der Server ohnehin
 * prüfen.
 */
...
export function HeaderImageSheet({
  ...
  const choose = (file: File | undefined) => {
    ...
    // Vor dem Hochladen und nicht danach: zehn Megabyte über eine
    ...
    >
      <div className="space-y-2">
        <Choice
          ...
          hint="Querformat sieht am besten aus — der Ausschnitt kommt aus der Mitte."
          disabled={busy}
